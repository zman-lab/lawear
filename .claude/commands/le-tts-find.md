...
2. 해당 파일 Read (세부 규칙 로드)
3. `docs/tts_progress.md`에서 해당 과목 섹션을 읽어 진행 현황 표 출력 (필수!)
4. 사용자에게 아래 형식으로 보고:
...
> 다음 작업: {미착수 중 첫 번째} — 번호 지정해주세요.
```

5. 파일이 TODO 상태(내용 없음)이면: "아직 세부 규칙 미작성. 공통 규칙(tts_rules.md)만으로 진행합니다."
