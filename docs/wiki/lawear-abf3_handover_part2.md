...
3. **게시판 환경 의존**: 본 세션 중 10.77.11.110:8585 OFF/ON 변동 사례 발견. 게시판 = 10.77.11.110만 사용 룰(다른 머신 접근 위해). OFF 시 위키 .md fallback이 메인. **10.77.11.110:8585에 작성하면 사용자가 못 봄** — 발견 시 10.77.11.110에 재발행 필요
