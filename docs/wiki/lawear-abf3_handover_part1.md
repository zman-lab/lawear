...
6. **게시판 환경 의존** — 10.77.11.110:8585 본 세션 중 OFF/ON 변동. 우분투 OFF 시 10.77.11.110:8585 fallback이지만 다른 머신 접근 X → 메모리 권고 `feedback_handover_board_env_dependency` (Part 1 §12)
